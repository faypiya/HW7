...
# Your name: Fay Piyathassrikul
# Your student id: 93808966
# Your email: faypiya@umich.edu
...
def make_players_table(data, cur, conn):
    ...
    positions = {position[1]: position[0] for position in cur.execute("SELECT * FROM Positions")}
    for player in data['squad']:
        name = player['name']
        position = player['position']
...
def nationality_search(countries, cur, conn):
    ...
    for country in countries:
        cur.execute("SELECT Players.name, Players.position_id, Players.nationality FROM Players WHERE Players.nationality=?", (country,))
